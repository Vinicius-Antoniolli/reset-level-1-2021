...
public abstract class Character {
    ...
    public Character(String nome, double altura, int idade) {
        this.nome = nome;
        this.altura = altura;
        this.idade = idade;
        this.estamina = 100;
    ...
    public void imprimeCaracteristicas() {
        ...
        System.out.println(this.getVidas() + " vida(s)");
        System.out.println("Possui " + this.getMoedas() + " moedas.");
        System.out.println("Você tem " + this.getEstamina() + " de energia.");
    }
    ...
    public void saltar(){
        System.out.println(this.nome + "está saltando a uma altura de " + this.altura*0.5 + " metros!");;
    }

    public void saltar(double objeto){
        System.out.println(this.nome + " saltou um objeto a sua frente a uma altura de " +objeto*1.5 +" metros!!" );
    }
